...
CHROMA_DIR = Path(r" Enter your chromadb database destination ")
...
for i in tqdm(range(0, len(all_chunks), BATCH_SIZE), desc="Embedding chunks"):
    ...
    batch_embs = model.encode(batch_chunks, batch_size=BATCH_SIZE,
...
print(f"✅ Done: processed {len(all_chunks)} chunks, stored in {CHROMA_DIR}")
